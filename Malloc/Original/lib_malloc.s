...
memory_alloc:
    ...
    je abre_memoria
    movq %rdi, %r13                                 #%r13 = tamanho da maior memoria alocada livre, inicia com o tamanho requisitado
  ...
  procura_maior_memoria_livre:                      #Coloca o endereco da maior memoria livre >= que a requisitada em %r12 e seu tamanho em %r13
    ...
    jl incremento                                   #coloca o tamanho da memoria apontada por %r10 em %r13 e copia %r10 para %r12
    movq %r10, %r12
    movq %r11, %r13
  ...
  fragmenta_memoria:                                #Se a diferenca do tamanho da memoria apontada por %r12 e o tamanho da memoria solicitada
    ...
    jl fim
    movq %r12, %r10
    addq %rdi, %r10                                 #Ordem certa? %r10 = %r10 + %rdi?
    addq $9, %r10
    subq $9, %r9
    movb $0, -9(%r10)
    movq %r9, -8(%r10)
